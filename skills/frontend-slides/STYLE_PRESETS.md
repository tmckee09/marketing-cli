...
Curated visual styles for Frontend Slides. Each preset draws on real design references — no generic "AI slop" aesthetics. **Abstract shapes only — no illustrations.**
