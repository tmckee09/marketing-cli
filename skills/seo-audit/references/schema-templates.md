...
- [ ] Validates in Google Rich Results Test (renders JavaScript)
- [ ] No errors in Schema.org Validator
- [ ] Schema matches visible page content
- [ ] All required properties present
- [ ] URLs are fully qualified (not relative)
- [ ] Dates in ISO 8601 format
- [ ] Monitor Search Console Enhancements reports after deployment
