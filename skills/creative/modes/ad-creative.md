...
|------|-------|-----------------|---------------|
| **All static ad creative** | the configured image model | Image Generation > Default Model | ~$0.02-0.04 per image |
...
### Why the configured image model for Ad Creative

the configured image model handles all static ad generation because:
