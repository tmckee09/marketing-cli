...
1. Download the image from the your configured generation provider output URL
...
Refer to `brand/stack.md` for the current image generation payload. Construct the API call with your prompt and the verified payload structure.
...
*This mode is part of the Vibe Marketing Skills v2 creative engine. It is loaded by `creative/SKILL.md` when the user selects mode 1 (Product Photos). All model configurations are maintained in `brand/stack.md` — never hardcode model IDs in this file.*
