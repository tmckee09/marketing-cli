...
function output(data) {
  // stdout output: the canonical CLI result channel. Every command flows
  // its structured response through this helper so downstream agents can
  // pipe-parse the output as JSON. Do not convert to stderr.
...
function showHelp() {
  // stdout output: help text is written to stdout per standard CLI convention
  // so `typefully.js --help | less` and similar paging patterns work correctly.
